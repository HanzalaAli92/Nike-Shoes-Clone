      ...
      <div className="flex flex-col lg:flex-row lg:gap-10 w-full max-w-6xl">
        <div className="lg:w-2/3 border-r border-gray-300 lg:pr-6 mb-6 lg:mb-0">
          ...
          <div className="flex gap-4 mb-8">
            <button className="bg-black text-white px-4 py-2 rounded-full hover:bg-gray-800">JOIN US</button>
            <button className="bg-black text-white px-4 py-2 rounded-full hover:bg-gray-800">SHOP NIKE</button>
          </div>
          ...
          <div className="mb-4">
            ...
            <p className="text-gray-700">Please note, some banks may charge a small transaction fee for international orders.</p>
          </div>
          <div className="mb-4">
          ...
          <p className="text-gray-600 text-sm mt-6">Was this answer helpful?</p>
          <div className="flex">
            <Image src="/like.png" alt="Like" width={30} height={30} className="hover:cursor-pointer" />
            <Image src="/dislike.png" alt="Dislike" width={30} height={30} className="hover:cursor-pointer" />
          </div>
          
          <p className="text-gray-600 text-sm mt-1">RELATED</p>
          <div className="gap-2 ml-6 mt-7">
            <a href="#" className="text-blue-500 block underline">WHAT ARE NIKE&apos;S DELIVERY OPTIONS?</a>
            <a href="#" className="text-blue-500 block underline">HOW DO I GET FREE DELIVERY ON NIKE ORDERS?</a>
          </div>
        </div>
